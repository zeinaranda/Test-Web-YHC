...
<title>Halaman Admin - Tambah Materi</title>
</head>
                ...
                <div class="card col-lg-12 p-3">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control" rows="10" placeholder="Masukan Isi Deskripsi" name="deskripsi"></textarea>
                        </div>
                        <div class="mb-3">

...
<head>
    ...
    <title>Halaman Admin - Tambah Kursus</title>
</head>
                    ...
                    <div class="card col-lg-12 p-3">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" placeholder="Masukan Ringkasan" name="deskripsi"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Durasi</label>
                                <input type="text" class="form-control" placeholder="Masukan Stok" name="durasi">
                            </div>
